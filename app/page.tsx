...
`
    ...
    if (themeType === 'events') {
      ...
      // Resets the summary total table's own margin, as with .table above.
      css += `.regform-summary-total-table {margin-bottom: 0px;}\n`
    ...
    styles.forEach((style, index) => {
      ...
      // A style with no border set should not emit a border declaration at all,
      // rather than "border: 0px solid <button colour>".
      const btnBorderDecl = styleHasButtonBorder(style)
